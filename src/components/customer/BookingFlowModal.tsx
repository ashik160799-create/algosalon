              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    color: anyStaff ? currentThemeConfig.contrastText || '#ffffff' : undefined,
                    borderColor: anyStaff ? currentThemeConfig.primaryHex : undefined,
                  }}
                >
                  ...
                  >
                    ...
                    {days.find(d => d.hasAnyFutureSlots) && (
                      <button
                        ...
                        className="px-4 py-2 rounded-xl text-xs font-black shadow-md transition-all active:scale-95 cursor-pointer inline-flex items-center gap-1.5"
                        style={{
        ...
        <div className={`pt-3.5 border-t flex items-center justify-between ${isLight ? 'border-slate-100' : 'border-slate-800'}`}>
          {currentStep === 5 ? (
            <button
              ...
              className="w-full py-3 rounded-2xl font-extrabold text-xs shadow-lg transition-all flex items-center justify-center gap-2 active:scale-98"
              style={{
                backgroundColor: currentThemeConfig.primaryHex,
                color: currentThemeConfig.contrastText || '#ffffff',
