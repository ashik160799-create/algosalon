...
export const CustomerHome: React.FC = () => {
  ...
  const exploreSalons = useMemo(() => {
    let result = salons.filter(salon => {
      ...
      const salonLive = computeSalonLiveStatus(salon.workingHours, salon.specialSchedules, salon.isOpenNow, salon);
                ...
                >
                  <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-200 dark:bg-slate-950">
                    ...
                    <div className="absolute top-2.5 left-2.5">
                      {(() => {
                        const cardLive = computeSalonLiveStatus(salon.workingHours, salon.specialSchedules, salon.isOpenNow, salon);
                        return (
                          <span
