          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar text-xs">
            <button
              ...
              style={{
                ...
                color: activeFilter === 'pending' ? currentThemeConfig.contrastText || '#ffffff' : undefined,
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                color: activeFilter === 'rescheduled' ? currentThemeConfig.contrastText || '#ffffff' : undefined,
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                color: activeFilter === 'all' ? currentThemeConfig.contrastText || '#ffffff' : undefined,
              }}
            >
        ...
        {filteredAppointments.length === 0 ? (
          ...
          >
            ...
            {activeFilter !== 'pending' && (
              <button
                onClick={() => setActiveFilter('pending')}
                className="mt-4 px-4 py-2 rounded-xl text-xs font-bold shadow-xs cursor-pointer"
                style={{
          ...
          >
            ...
            <div className="mt-4 space-y-2.5">
              <a
                ...
                className="w-full py-3 px-4 rounded-2xl font-black text-sm shadow-md transition-all flex items-center justify-center gap-2 hover:opacity-95 active:scale-98"
                style={{
                  backgroundColor: currentThemeConfig.primaryHex,
                  color: currentThemeConfig.contrastText || '#ffffff',
          ...
          >
            ...
            <form onSubmit={handleConfirmSuggestTime} className="p-6 space-y-4">
              ...
              <div className="pt-3 border-t border-slate-800 flex items-center justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-2xl text-xs font-black shadow-lg transition-transform hover:scale-105 active:scale-95 flex items-center gap-1.5"
                  style={{
                    backgroundColor: currentThemeConfig.primaryHex,
                    color: currentThemeConfig.contrastText || '#ffffff',
